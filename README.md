...
|---|---:|
| grid only | 64 / 100 |
| + closed-form families (Göbel strips/squares, L extensions) | 75 / 100 |
| + tilted-block search | 78 / 100 |
| + numerical compaction (60 s) | 78 / 100 |

* mean gap to the best known side over all 100 values: 0.00466
* every returned packing passes the exact verifier (max penetration ≤ 1e-9)
* time: closed-form families 0.09 s total, tilted-block search 143 s total, numerical search 60 s for each non-proven n
* the numerical search alone rediscovers Trump's n = 11 record (3.8770836) from random starts and lands within
  4·10⁻⁵ of the n = 18 record (7/2 + √7/2) and 1.2·10⁻³ of the n = 19 record (3 + 4√2/3)
...
| 17 | 4.696994 | 4.675530 | +0.021464 | numeric:bisect:grid |
| 18 | 4.822915 | 4.822876 | +0.000040 | numeric:bisect:random |
| 19 | 4.886753 | 4.885618 | +0.001135 | numeric:tilted_block |
| 28 | 5.828427 | 5.824445 | +0.003983 | gobel_square |
| 29 | 6.000000 | 5.933833 | +0.066167 | grid |
| 37 | 6.621320 | 6.598620 | +0.022701 | tilted_block |
| 39 | 6.828427 | 6.810722 | +0.017705 | gobel_square+L |
| 41 | 6.949747 | 6.926693 | +0.023054 | tilted_block |
| 50 | 7.621320 | 7.571429 | +0.049892 | tilted_block |
| 51 | 7.707107 | 7.700799 | +0.006308 | gobel_strip+L+L |
| 53 | 7.828427 | 7.822876 | +0.005551 | gobel_square+L |
| 54 | 7.856962 | 7.846667 | +0.010294 | numeric:tilted_block |
| 55 | 8.000000 | 7.945771 | +0.054229 | grid |
| 68 | 8.828427 | 8.803460 | +0.024967 | gobel_square+L+L |
| 69 | 8.857199 | 8.827212 | +0.029987 | numeric:tilted_block |
| 70 | 8.904857 | 8.881667 | +0.023191 | numeric:tilted_block |
| 71 | 9.000000 | 8.944072 | +0.055928 | grid |
| 83 | 9.656854 | 9.634826 | +0.022029 | tilted_block |
| 86 | 9.828427 | 9.822876 | +0.005551 | tilted_block |
